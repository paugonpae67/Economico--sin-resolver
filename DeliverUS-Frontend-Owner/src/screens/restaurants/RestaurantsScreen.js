  ...
  const renderRestaurant = ({ item }) => {
    ...
    return (
      ...
      >
        ...
        {item.economic
          ? <TextRegular textStyle = {[styles.economico, { color: GlobalStyles.brandSuccess, borderColor: GlobalStyles.brandSuccess }]}>€</TextRegular>
          : <TextRegular textStyle ={[styles.economico, { color: GlobalStyles.brandPrimary, borderColor: GlobalStyles.brandPrimary }]}>€€</TextRegular>}
